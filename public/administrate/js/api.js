...
export function getDailySummaryInfo(userId, selectedDate) {
    return $.ajax({
        type: "GET",
        url: `${window.DOMAIN_URL}/admin/users/${userId}/daily-summaries/${selectedDate}/macros`,
        contentType: "application/json",
    })
}
...
export function getConsumedFoodsByDate(userId, selectedDate) {
    return $.ajax({
        type: "GET",
        url: `${window.DOMAIN_URL}/admin/users/${userId}/consumed-foods?date=${selectedDate}`,
        contentType: "application/json",
    });
}
